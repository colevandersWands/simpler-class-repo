module.exports = (coach, mainData) => (
  ...
  `        <li><a href="https://github.com/${mainData.userName}/${mainData.repoName}/issues?q=author%3A${coach.userName}">authored</a></li>\n` +
  `        <li><a href="https://github.com/${mainData.userName}/${mainData.repoName}/issues?q=assignee%3A${coach.userName}">assigned</a></li>\n` +
  `    </ul>\n` +
  `  </td>\n` +
  `</tr></table>`
);
