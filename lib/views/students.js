module.exports = (student, mainData) => (
  ...
  `        <li><a href="https://github.com/${mainData.userName}/${mainData.repoName}/issues?q=author%3A${student.userName}">authored</a></li>\n` +
  `        <li><a href="https://github.com/${mainData.userName}/${mainData.repoName}/issues?q=assigned%3A${student.userName}">assigned</a></li>\n` +
  `    </ul>\n` +
  `  </td>\n` +
  `</tr></table > `
);
